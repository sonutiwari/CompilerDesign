                ...
                if(tok.type!='DATATYPE'and tok.type!='NEWLINE'and tok.type!='MLINECOMMENTS'and tok.type!='SLINECOMMENT'
                   and tok.type!='PTR'):
                    if(tok.type=='IDENTIFIER'):
                        ...
                        value='--'
                    print(tok.lineno,'\t\t',tok.val,'\t\t',tok.type,'\t\t',value,g)
                return tok
...
f=open('lexicalAnalyser.c')
inp=f.read()
f.close()
lx.input(inp)
staticTable=[]
try:
    print('\nOutput Table\nLine NO\t\t','Lexeme\t\t','Token\t\t','Specifier',g)
...
print('\nSymbolTable\n',g)
print('Address\t','\tSymbol','\t\tType\t','\tSize',g)
for i in symbolTable:
    print(i[1][0],'(',int(i[1][0],16),')\t\t',i[0],'\t\t',i[1][1],'\t\t',i[1][2],g)
        

print('\nNumTable\n',g)
print('Number\t','\tToken','\t\tType\t','\tValue',g)
for i in numTable:
    print(i[0],'\t\t',i[1][2],'\t\t',i[1][3],'\t\t',i[1][1],g)
